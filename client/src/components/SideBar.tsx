...
const SideBar: React.FC<SideBarProps> = ({}) => {
  return (
    <nav className="flex flex-col justify-between items-start fixed w-1/6 h-screen bg-off-black">
      <div>
        <span className="block font-viga text-2xl mt-8 ml-8 text-white">
          <h1>NALMDB</h1>
        </span>
      </div>
      <div className="flex flex-col justify-between gap-3 w-full">
        ...
        <span className="flex flex-row justify-start items-end gap-2 ml-8 mt-2 font-sarabun font-lg font-normal text-light-grey leading-tight">
